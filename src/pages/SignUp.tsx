...
export const SignUp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 text-slate-900 font-sans relative selection:bg-slate-900 selection:text-white">
      ...
      <div className="absolute bottom-1/4 left-10 w-[250px] h-[250px] bg-amber-50/50 rounded-full blur-[80px] pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-slate-200 p-8 relative z-10 text-left">
        <div className="mb-6">
          ...
          <p className="text-xs text-slate-500 mt-1">Join Bisht Uttarakhandi Store and start decorating your spaces with premium crafts immediately.</p>
        </div>
